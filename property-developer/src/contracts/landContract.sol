...
contract LandContract {
    ...
    constructor() public {
        owner = msg.sender;
        plots[0].price = 400000000000000000000;
        plots[0].forSale = true;
        plots[1].price = 4000000000000000000;
        plots[1].forSale = true;
        plots[2].price = 4000000000000000000;
        plots[2].forSale = true;
        plots[3].price = 4000000000000000000;
        plots[3].forSale = true;
        plots[4].price = 4000000000000000000;
        plots[4].forSale = true;
        plots[5].price = 4000000000000000000;
        plots[5].forSale = true;
        plots[6].price = 4000000000000000000;
        plots[6].forSale = true;
        plots[7].price = 4000000000000000000;
        plots[7].forSale = true;
        plots[8].price = 4000000000000000000;
        plots[8].forSale = true;
        plots[9].price = 4000000000000000000;
        plots[9].forSale = true;
        plots[10].price = 4000000000000000000;
        plots[10].forSale = true;
        plots[11].price = 4000000000000000000;
    ...
    function withdrawFunds() public {
        address payee = msg.sender;
          ...
          balances[payee] = 0;
          require(payee.transfer(payment));
    }
